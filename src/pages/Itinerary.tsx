                            ...
                            <motion.div variants={fadeAnim} initial="hidden" animate="visible" className="space-y-10">
                                <div className="flex flex-col gap-3">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full sm:w-[400px] md:w-[570px] lg:w-[820px] h-[200px] border border-[#E5D4EF] rounded-lg px-4 py-2 outline-none focus:border-[#B749DB] focus:ring-2 focus:ring-[#B749DB]/30 transition resize-none placeholder:text-gray-400"
                                    ></textarea>
                                </div>
                            </motion.div>
                        )}
