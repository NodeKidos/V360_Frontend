                        ...
                        <motion.div variants={fadeAnim} initial="hidden" animate="visible" className="space-y-10">
                            <div className="flex flex-col gap-3">
                                ...
                                <input
                                    ...
                                    className="w-[934px] h-[200px] border border-[#E5D4EF] rounded-lg px-4 py-2 outline-none focus:border-[#B749DB] focus:ring-2 focus:ring-[#B749DB]/30 transition"
                                />
                            </div>
                            {/* ✅ Prev + Submit (without arrow) */}
                            <div className="flex justify-between mt-10">
                                <button
                                    onClick={prevStep}
                                    className="flex items-center gap-2 border border-[#B749DB] text-[#5B247A] font-semibold px-8 py-2.5 rounded-lg hover:bg-[#B749DB]/10"
                                ...
                                <button
                                    ...
                                    className="border border-[#B749DB] text-[#5B247A] font-semibold px-8 py-2.5 rounded-lg hover:bg-[#B749DB]/10"
                                >
                                    Submit
                                </button>
                            </div>
