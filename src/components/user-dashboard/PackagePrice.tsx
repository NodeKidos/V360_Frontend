...
const PackagePricingSummary = () => {
  ...
  const [totalPrice, setTotalPrice] = useState(2800);
  const [perPersonPrice, setPerPersonPrice] = useState(700);
  const [remarks, setRemarks] = useState("Includes accommodation, transport, entrance tickets, and taxes");
