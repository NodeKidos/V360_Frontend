                        ...
                        <TabsContent value="destination">
                            ...
                            <div className="mb-6 overflow-x-auto rounded-lg border border-gray-200" style={{ scrollbarWidth: "thin" }}>
                                <table className="min-w-full bg-white">
                                    <thead>
                                        <tr className="bg-gray-50 text-[#382A59] font-semibold text-[16px] sm:text-[16px] md:text-[15px] text-center font-poppins">
                                    ...
                                    <tbody className="font-poppins">
                                        {currentDestinations.map((d) => (
                                            <tr key={d.id} className="border-b border-gray-100 text-center text-[15px] sm:text-[16px] md:text-[16px] hover:bg-gray-50">
